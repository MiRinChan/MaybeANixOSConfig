# From https://github.com/NixOS/nixpkgs/blob/master/pkgs/by-name/rq/rquickshare/package.nix
{
  appimageTools,
  lib,
  fetchurl,
  ...
  version = "0.11.2";
  src = fetchurl {
    url = "https://github.com/Martichou/rquickshare/releases/download/v${version}/r-quick-share-main_v${version}_glibc-2.31_amd64.AppImage";
